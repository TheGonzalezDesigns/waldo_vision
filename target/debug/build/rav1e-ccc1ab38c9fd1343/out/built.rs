...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/ubuntu/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/ubuntu/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/home/ubuntu/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.88.0 (6b00bc388 2025-06-23)";
#[doc=r#"The output of `/home/ubuntu/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/ubuntu/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
